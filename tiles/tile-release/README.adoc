...
== Description
This is the foundation tile of all other releases for the platform. 

It defines how a Maven project is to be released to Central and what plugins must run (and pass) 
for this to happen. Other tiles will build on this one.
